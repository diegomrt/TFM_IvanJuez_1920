...
if __name__=='__main__':
	...
	#cálculo para el centro de masas de la esfera
	#plano x
	alpha=math.atan(z/x) #esto me devuelve el ángulo en radianes
	alp= math.degrees(alpha)
	beta=math.atan(z/y) #esto me devuelve el ángulo en radianes
	bet= math.degrees(beta)
	if radio < 15:
	    #radio esfera pequeña = 2 cm
	    cos_alp=math.cos(alp)
	...
	if debug == True:
		...
		print "\n La posiciones de los objetos de pick creada en Gazebo con kinect corregida son " ,"x= ", x_final ,"y= ", y_final ,"z=" , z , "radio= ", radio
