...
public:
  ObjectDetection()
  {
    ...
    pub_red_cylinder = nh.advertise<PointCloud> ("/filter5", 1);
    pub_blue_cylinder = nh.advertise<PointCloud> ("/filter6", 1);
    ...
    sub_blue = nh.subscribe<PointCloudRGB>("/camera/depth/points", 1, &ObjectDetection::bluefilter_callback, this);
    sub_red = nh.subscribe<PointCloudRGB>("/camera/depth/points", 1, &ObjectDetection::redfilter_callback, this);
    sub_green = nh.subscribe<PointCloudRGB>("/camera/depth/points", 1, &ObjectDetection::greenfilter_callback, this);
  }
  ...
  {
    detect_cylinder(msg, pub_red_cylinder, "red_cylinder");
  }

  void blue_cylinder_callback(const PointCloud::ConstPtr& msg)
  {
    detect_cylinder(msg, pub_blue_cylinder, "blue_cylinder");
  }
