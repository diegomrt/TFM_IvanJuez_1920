...
if __name__=='__main__':
	...
	# Dimensiones de las cajas y de la mesa [largo, ancho, altura] de momento no lo hago automáticamente
	box1_size=[0.05, 0.05, 0.05]
        ...
        box1_pose.pose.position.x = posicion_cubo.pose.position.x
        box1_pose.pose.position.y = posicion_cubo.pose.position.y
	box1_pose.pose.position.z = posicion_cubo.pose.position.z 
