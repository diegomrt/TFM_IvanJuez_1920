...
class CameraManager:
    def __init__(self):
        self.cam_robot_rgb = rospy.Subscriber("camera/rgb/image_raw", Image, self.cam_robot_rgb_callback)
        self.cam_fixed_rgb = rospy.Subscriber("camera/rgb/image_raw", Image, self.cam_fixed_rgb_callback)
        self.cam_robot_depth = rospy.Subscriber("camera/depth/points", PointCloud2, self.cam_robot_depth_callback)
        self.cam_fixed_depth = rospy.Subscriber("camera/depth/points", PointCloud2, self.cam_fixed_depth_callback)
